...
export function IFrameVideoModal({ showModelCollectionLink, modelCollectionUrl, onSubmit, onClose }) {
  ...
  return (
    ...
    >
      <Column as="form" padding center onSubmit={handleSubmit(onSubmit)}>
        ...
        <iframe width="560" height="315" src="https://www.youtube.com/embed/8-oeZmlM67w" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        <TextInputField
          name="url"
